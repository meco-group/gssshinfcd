classdef  MX < casadi.GenericExpressionCommon & casadi.PrintableCommon & casadi.GenMX & casadi.SharedObject
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(716, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(717, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(728, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(729, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(730, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(731, varargin{:});
    end
