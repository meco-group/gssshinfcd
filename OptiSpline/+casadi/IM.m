classdef  IM < casadi.MatrixCommon & casadi.GenericExpressionCommon & casadi.GenIM & casadi.PrintableCommon
  ...
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(516, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(568, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(569, varargin{:});
    end
